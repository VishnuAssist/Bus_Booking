            ...
            <Card>
              <CardContent>
                ...
                <Box sx={{ mt: 3, textAlign: "center" }}>
                  ...
                  <Typography variant="subtitle1">
                    All achievement progress entries have been reviewed.
                  </Typography>
                </Box>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent>
                <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                  ...
                  <Typography fontSize={16} fontWeight={600}>
                    Staff Requests Pending Review
                  </Typography>
                </Box>
                <Box sx={{ mt: 3, textAlign: "center" }}>
                  <DescriptionOutlinedIcon style={{ fontSize: 50 }} />
                  <Typography variant="subtitle1">
                    Staff request management interface would appear here.
                  </Typography>
                  <Typography variant="subtitle1">
                    Admins can approve/reject MC applications, leave requests,
                    and shift changes.
                  </Typography>
                </Box>
              </CardContent>
