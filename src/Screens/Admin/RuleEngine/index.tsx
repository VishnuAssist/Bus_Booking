...
import { Add, Edit, Delete, ContentCopy, CheckCircle, WarningAmber, AccessTime } from "@mui/icons-material";
...
const RuleEngine: React.FC = () => {
    ...
    return (
        <>
            <CommisionContainer>
                <PageHeader title="Commission Rules" subtitle="Manage commission calculation rules and policies" btntitle="Create Rule" icon={<Add />} onActionClick={handleCreate} />
                <Box>
                    {isCreating && (
                        <Card sx={{ mb: 3 }}>
