...
const Performance = () => {
    ...
    const performanceChart: { series: any[]; options: ApexOptions } = {
        ...
        options: {
            ...
            dataLabels: { enabled: false },
            xaxis: {
                categories: ["Sarah Chen", "Alex Kim", "Emily Johnson", "Marcus Rodriguez", "Lisa Wang", "David Park"],
            },
            yaxis: { labels: { formatter: (val) => `${val / 1000}k` } },
            grid: { strokeDashArray: 3 },
            legend: { position: "top" },
    ...
    const insights = [
        ...
        { label: "Goal Achievement", value: 88.5, color: "#1976d2", display: "88.5%" },
                                    ...
                                    <Box key={index} mb={2}>
                                        ...
                                        <LinearProgress
                                            ...
                                            sx={{
                                                ...
                                                "& .MuiLinearProgress-bar": { backgroundColor: insight.color },
                                            }}
                                        />
                                    </Box>
                                ))}
