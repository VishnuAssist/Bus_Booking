...
import { StaffAchivement, staffAchivementFormValidationSchema } from "../../../feilds_validation/staffAchivementFieldsValidation";
...
const Achievements = () => {
    ...
    return (
        <>
            <CommisionContainer>
                <PageHeader title="Achievement Progress" subtitle="Log your daily activities toward achieving goals" btntitle="Log Activity" icon={<AddIcon />} />

                <Grid container spacing={2}>
                    <Grid size={12}>
                        <Grid container spacing={2}>
                            <Grid size={4}>
                                <Card sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", p: 2, height: "100%" }}>
                                    <Box>
                                        <Typography color="primary" fontSize={16} fontWeight={700}>0</Typography>
                                        <Typography variant="subtitle1">Total Activities</Typography>
                                    </Box>
                                    <EmojiEventsOutlinedIcon color="primary" style={{ fontSize: 35 }} />
                                </Card>
                            </Grid>
                            <Grid size={4}>
                                <Card sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", p: 2, height: "100%" }}>
                                    <Box>
                                        <Typography color="warning" fontSize={16} fontWeight={700}>0</Typography>
                                        <Typography variant="subtitle1">Pending Verification</Typography>
                                    </Box>
                                    <AccessTimeOutlinedIcon color="warning" style={{ fontSize: 35 }} />
                                </Card>
                            </Grid>
                            <Grid size={4}>
                                <Card sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", p: 2, height: "100%" }}>
                                    <Box>
                                        <Typography color="success" fontSize={16} fontWeight={700}>0</Typography>
                                        <Typography variant="subtitle1">Verified</Typography>
                                    </Box>
                                    <CheckCircleOutlinedIcon color="success" style={{ fontSize: 35 }} />
                                </Card>
                            </Grid>
                        </Grid>
                    </Grid>
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <Box sx={{ mt: 3, textAlign: "center" }}>
                                    ...
                                    <Typography variant="subtitle1">No activities logged yet.</Typography>
                                    <Typography variant="subtitle1">Start tracking your progress by logging your first activity!</Typography>
                                </Box>
