...
import { useAddEditSaleMutation, useDeleteSaleMutation, useGetAllSalesQuery } from "../../Api/salesApi";
...
const Sales = () => {
    ...
    const { data: subsubcategoriesData } = useGetalldictionaryQuery({ Category: 9 });
   ...
   const SalesColumns = [
    ...
    const onSubmit = async (formData: any) => {
        ...
        try {
            ...
            toast.success(selectedSales ? "Sale updated successfully" : "Sale created successfully");
            handleModalClose();
        } catch (error) {
    ...
    const SalesFields = () => {
        ...
        const subsubcategoryField = fields.find((f) => f.name === "subSubCategoryId");
        ...
        <>
            <CommisionContainer>
                <PageHeader 
                    ...
                    onActionClick2={() => setModalOpen(true)} 
